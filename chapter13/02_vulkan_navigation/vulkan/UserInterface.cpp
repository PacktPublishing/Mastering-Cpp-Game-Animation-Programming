...
void UserInterface::createSettingsWindow(VkRenderData& renderData, ModelInstanceCamData& modInstCamData) {
  ...
  if (ImGui::CollapsingHeader("Camera")) {
    ...
    if (mSurrentCamera != modInstCamData.micCameras.at(modInstCamData.micSelectedCamera)) {
      mSurrentCamera = modInstCamData.micCameras.at(modInstCamData.micSelectedCamera);
