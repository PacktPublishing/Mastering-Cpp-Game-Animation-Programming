...
std::vector<TRSMatrixData> ShaderStorageBuffer::getSsboDataTRSMatrixData() {
  std::vector<TRSMatrixData> ssboData;
  ssboData.resize(mBufferSize / sizeof(TRSMatrixData));
...
size_t ShaderStorageBuffer::getBufferSize() {
  return mBufferSize;
}
