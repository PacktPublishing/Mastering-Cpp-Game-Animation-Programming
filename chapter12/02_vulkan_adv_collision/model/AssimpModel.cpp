...
bool AssimpModel::loadModel(VkRenderData &renderData, std::string modelFilename, unsigned int extraImportFlags) {
  ...
  ShaderStorageBuffer::uploadData(renderData, mShaderBoneMatrixOffsetBuffer, mBoneOffsetMatricesList);
  ShaderStorageBuffer::uploadData(renderData, mInverseBoneMatrixOffsetBuffer, mInverseBoneOffsetMatricesList);
